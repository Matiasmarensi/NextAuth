    ...
    <div className="flex items-center justify-center h-screen">
      <div className="max-w-md p-6 bg-gradient-to-r from-gray-400 to-gray-400 border-gray-900 border-2 rounded-md shadow-lg transition-transform transform hover:scale-105">
        ...
        <p className="text-lg mb-4 text-gray-600">
          ¡Hola! Soy Matías, el creador de este proyecto desarrollado con Next.js y NextAuth. Es una aplicación web que
          destaca la integración de Next.js para el front-end y NextAuth para la autenticación.
        </p>
        <p className="text-lg mb-4 text-gray-600">
        ...
        <p className="text-lg mb-4 text-gray-600">
          Siéntete libre de explorar todas las características. Si tienes alguna pregunta o comentario, ¡no dudes en
